namespace Data
{
	public class UnitOfWork : Base.UnitOfWork, IUnitOfWork
	{
		...
		// **************************************************
		private ISamplePaydarRepository _samplePaydarRepository;

		public ISamplePaydarRepository SamplePaydarRepository
		{
			get
			{
				if (_samplePaydarRepository == null)
				{
					_samplePaydarRepository =
						new SamplePaydarRepository(DatabaseContext);
				}

				return _samplePaydarRepository;
			}
		}
		// **************************************************
	}
