...
using PaydarShop.Server.Middleware;
...
namespace Dtx.Security.Server
{
	public class Startup : object
	{
			...
			(Microsoft.Extensions.DependencyInjection.IServiceCollection services)
		{
			...
			services.Configure<PaydarShop.Server.Infrastructure.applicationsettings.Main>
				(Configuration.GetSection("AppSettings"));
			
			//services.AddTransient<Dtx.ILogger, Dtx.Logger>();

			services.AddScoped<PaydarShop.Server.Services.IUserService , PaydarShop.Server.Services.UserService>();
		}
